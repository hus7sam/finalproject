...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public List<user_information_Internal> SearchWords(String searchWord){
        List<user_information_Internal> mItems = new ArrayList<user_information_Internal>();
        ...
        Cursor cursor = this.getReadableDatabase().rawQuery(query, null); ArrayList<String> wordTerms = new ArrayList<String>(); if(cursor.moveToFirst()){
            do{
                ...
                mItems.add(new user_information_Internal(id,name)); }while(cursor.moveToNext());
